...
class Sentence():
    ...
    def known_mines(self):
        ...
        If the number of cells in the sentence is equal to the count of mines
        in the sentence and the count is greater than 0
...
class MinesweeperAI():
    ...
    def make_safe_move(self):
        ...
        A safe cell is a cell that is known to be safe, and not already a move that has been made.
        """
